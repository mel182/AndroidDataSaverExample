...
import com.example.datasaverexampleapp.databinding.ActivityAppBarCollapsingToolbarWithImageExampleBinding
...
class AppBarCollapsingToolbarWithImageExampleActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DataBindingUtil.setContentView<ActivityAppBarCollapsingToolbarWithImageExampleBinding>(
            this, Layout.activity_app_bar_collapsing_toolbar_with_image_example
        ).apply {
