...
import com.example.datasaverexampleapp.databinding.FragmentContent1Binding
...
class ContentFragment1 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.apply {
            ...
            DataBindingUtil.setContentView<FragmentContent1Binding>(
                this, Layout.fragment_content1
            ).apply {
                itemList.apply {
