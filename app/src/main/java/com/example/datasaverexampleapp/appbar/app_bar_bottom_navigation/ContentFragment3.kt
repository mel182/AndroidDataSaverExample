...
import com.example.datasaverexampleapp.databinding.FragmentContent3Binding
...
class ContentFragment3 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.apply {
            DataBindingUtil.setContentView<FragmentContent3Binding>(
                this, Layout.fragment_content3
            ).apply {
